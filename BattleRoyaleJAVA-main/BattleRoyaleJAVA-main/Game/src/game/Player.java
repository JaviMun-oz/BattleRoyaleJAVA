...
public class Player implements Comparable<Player> {
    ...
    public int getMaxHealth() { return character.getBaseHealth(); }
    public int getTotalAttack() { return character.getBaseAttack() + weapon.getAttackModifier(); }
    public int getTotalDefense() { return character.getBaseDefense() + weapon.getDefenseModifier(); }
    public int getTotalSpeed() { return character.getBaseSpeed() + weapon.getSpeedModifier(); }
    ...
    @Override
    // Players are compared by current health
    public int compareTo(Player other) {
        return Integer.compare(this.getCurrentHealth(), other.getCurrentHealth());
    }
}